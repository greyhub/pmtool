...
| End-to-end — trình duyệt thật | Playwright (Chromium), build dev thật của web + api | 36 test / 27 file | ✅ 35 đạt, 1 tự bỏ qua vì chưa cấu hình Telegram trong môi trường này, 1,8 phút |
