...
| J4 Thực thi | E2E `task-ux`, `kanban-drag`, `sprints`, `sprint-burndown`, `sprint-review`, `gamification`; integration "Task history", "Quests", "Task assignees", "Sprints", "Sprint burndown", "Sprint review" | Telegram thật không kiểm thử E2E (cần webhook công khai) |
