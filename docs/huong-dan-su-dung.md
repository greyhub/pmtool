...
8. [Gamification: điểm, chuỗi ngày, huy hiệu](#8-gamification-điểm-chuỗi-ngày-huy-hiệu)
9. [Trợ lý AI](#9-trợ-lý-ai)
10. [Thông báo Telegram](#10-thông-báo-telegram)
11. [Giao diện: sáng/tối, song ngữ, di động](#11-giao-diện-sángtối-song-ngữ-di-động)
...
- Mỗi dự án có 5 tab: **Tổng quan** (dashboard), **Công việc** (danh sách WBS), **Bảng** (Kanban), **Tiến độ** (Gantt), **Rủi ro/Vấn đề**.
...
## 8. Gamification: điểm, chuỗi ngày, huy hiệu
...
## 11. Giao diện: sáng/tối, song ngữ, di động
