-- CreateEnum
CREATE TYPE "OrgRole" AS ENUM ('OWNER', 'ADMIN', 'PM', 'MEMBER', 'VIEWER');
...
-- CreateIndex
CREATE INDEX "membership_invites_organizationId_idx" ON "membership_invites"("organizationId");
...
-- AddForeignKey
ALTER TABLE "membership_invites" ADD CONSTRAINT "membership_invites_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
